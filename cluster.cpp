...
// Funzione che, dati un vector di samples e un vector di int, crea un nuovo cluster e lo ritorna
...
// Funzione che, dato un cluster, restituisce una stringa formata concatenando i nomi dei samples presenti nel cluster
...
// Funzione che, dato un cluster, restituisce il numero di elementi presenti nel cluster
int len(cluster c)
{
